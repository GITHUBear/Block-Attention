...
if __name__ == '__main__':
    ...
    random.seed(42)
    process_file(
        input_file=os.path.join(args.dir, "2wiki_train", "dataset"), output_file=os.path.join(args.dir, "2wiki_train", "all_gened_dataset"),
        refined_output_file=os.path.join(args.dir, "2wiki_train", "refine_gened_dataset"),
